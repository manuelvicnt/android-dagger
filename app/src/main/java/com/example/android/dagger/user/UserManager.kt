...
class UserManager @Inject constructor(private val storage: Storage) {
    ...
    *  a new User will be created. When the user logs out, this will be null.
    */
    ...
    fun logout() {
        // When the user logs out, we remove the instance of User from memory
        loggedInUser = null
    }
    ...
    private fun userJustLoggedIn() {
        // When the user logs in, we create a new instance of User
